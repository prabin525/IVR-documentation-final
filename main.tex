...
\newpage\input{sections/literature}
\newpage\input{sections/methodology}
\newpage\input{sections/software}
\newpage\input{sections/results}
\newpage\input{sections/limitations}
\newpage\input{sections/conclusion}
